...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Peak.summit_pos_5'
        db.alter_column(u'exo_peak', 'summit_pos_5', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Peak.summit_pos_pileup'
        db.alter_column(u'exo_peak', 'summit_pos_pileup', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'exo.peak': {
            ...
            'summit_pos_5': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'summit_pos_pileup': ('django.db.models.fields.PositiveIntegerField', [], {}),
