...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.id'
        db.add_column(u'exo_genome', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=-1, primary_key=True),
                      keep_default=False)


        # Changing field 'Genome.assembly_name'
        db.alter_column(u'exo_genome', 'assembly_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))
