...
python getSummit.py -c --mode ${mode} --shift ${shiftsize} --tsize $tagsize --rpkm 10 --pileup 0.5 -b ~/Documents/hg19.rejectRegion.bed -f fragsizes.txt -i ~/Downloads/MJF11_hg19/1_Bam/ -o $OUTDIR/ -w ~/Downloads/MJF11_hg19/1_Bam/test_apex/  MAX_sc-197_SNU16_XO111 MAX_sc-197_SNU16_XO211 RNAP-II_8WG16_HCT116_XO111 RNAP-II_8WG16_HCT116_XO211 RNAP-II_8WG16_SNU16_XO111 RNAP-II_8WG16_SNU16_XO21 -R ../final3/mappedCounts.txt

#   python mergeAndSort.py -i $OUTDIR/MAX_sc-197_SNU16_XO111_*_sh*_t*_peaks.out.xls -o $OUTDIR/MAX_sc-197_SNU16_XO111_peaks.out.xls -H
#   python mergeAndSort.py -i $OUTDIR/MAX_sc-197_SNU16_XO211_*_sh*_t*_peaks.out.xls -o $OUTDIR/MAX_sc-197_SNU16_XO211_peaks.out.xls -H
#   python mergeAndSort.py -i $OUTDIR/RNAP-II_8WG16_HCT116_XO111_*_sh*_t*_peaks.out.xls -o $OUTDIR/RNAP-II_8WG16_HCT116_XO111_peaks.out.xls -H
#   python mergeAndSort.py -i $OUTDIR/RNAP-II_8WG16_HCT116_XO211_*_sh*_t*_peaks.out.xls -o $OUTDIR/RNAP-II_8WG16_HCT116_XO211_peaks.out.xls -H
#   python mergeAndSort.py -i $OUTDIR/RNAP-II_8WG16_SNU16_XO111_*_sh*_t*_peaks.out.xls -o $OUTDIR/RNAP-II_8WG16_SNU16_XO111_peaks.out.xls -H
#   python mergeAndSort.py -i $OUTDIR/RNAP-II_8WG16_SNU16_XO21_*_sh*_t*_peaks.out.xls -o $OUTDIR/RNAP-II_8WG16_SNU16_XO21_peaks.out.xls -H
...
#  java -jar ~/Documents/annotate.jar -a ~/hg19_wgGencodeAttrsV14.txt -f MACSSUMMIT -r ~/hg19_wgEncodeGencodeCompV14.txt -i ~/Desktop/macs_out/final6/${OUTDIR}/*1_peaks.out.xls -b ~/Documents/hg19.rejectRegion.bed
   ...
   do
       ...
       python pair.py $OUTDIR/${j}_peaks.bed ~/Downloads/MJF11_hg19/1_Bam/test_apex/${j}_Forward.wig  ~/Downloads/MJF11_hg19/1_Bam/test_apex/${j}_Reverse.wig $OUTDIR/${j}
   done
