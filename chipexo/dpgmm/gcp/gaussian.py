...
class Gaussian:
  ...
  def __init__(self, dims):
    ...
    if isinstance(dims, Gaussian):
      ...
      self.precision = numpy.identity(dims, dtype=numpy.float64)
  ...
  def setCovariance(self, covariance):
    ...
    nc = numpy.array(covariance, dtype=numpy.float64)
  ...
  def sample(self):
    ...
    print "sample shape: ", self.mean.shape
